 ...
 * @author karmi
 */
public class think extends javax.swing.JFrame {

    /**
     * Creates new form think
     */
    public think() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(think.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
